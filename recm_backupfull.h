...
@command backup full
@definition
Perform an Online backup of PostgreSQL database.

@option "/verbose" "Display more details"
@option "/tag=TAG"           "Change default TAG value. (Default is 'YYYY_MM_DD_HHhMM'"
@option "/cleanup"           "Invoke 'delete backup/obsolete'"
@option "/exclusive"         "launch backup in 'exclusive' mode"
@option "/lock"              "Disable retention policy for this backup"
@option "/noindex"           "Remove indexes from backup"
@option "/verify"            "Invoke 'verify backup'"
@option "/wal"               "Invoke backup of wal after full backup"
@option "/verbose"           "Display more details"
@option "/tag=<String>"      "Define custom keyword to backup."
@option "/directory=<path>"  "Use a different location for this backup"
@option "/parallel=n"        "Launch backup with multiple threads"
@example
@inrecm back full /verb/wal/noindex/paral=4 
@out recm-inf: Starting backup at LSN 73/7000028, WALfile '000000240000007300000007'
@out recm-inf: Backup cluster 'CLU12' (CID 1)
@out recm-inf: Backup PGDATA folder '/Library/PostgreSQL/12/data'
@out recm-inf: Analyzing Database 'demo' objects
@out recm-inf: Analyzing Database 'depo_prod' objects
@out recm-inf: Analyzing Database 'limkydb' objects
@out recm-inf: Analyzing Database 'recm_db2' objects
@out recm-inf: Analyzing Database 'recmdb' objects
@out recm-inf: Analyzing Database 'recmrepo' objects
@out recm-inf: backup use 4 thread(s)
@out recm-inf: Each backup pieces will have an average size of 199 MB
@out recm-inf: Will create 9 pieces by 4 thread(s)
@out recm-inf: Creating piece '/Volumes/pg_backups/0001632ccc3918af9098_1_FULL.recm'
@out recm-inf: Creating piece '/Volumes/pg_backups/0001632ccc3918af9098_2_FULL.recm'
@out recm-inf: Creating piece '/Volumes/pg_backups/0001632ccc3918af9098_3_FULL.recm'
@out recm-inf: Creating piece '/Volumes/pg_backups/0001632ccc3918af9098_4_FULL.recm'
@out recm-inf: Backup Piece /Volumes/pg_backups/0001632ccc3918af9098_4_FULL.recm FileSize=1089113 (Compression ratio: 88.42%)
@out recm-inf: Backup Piece /Volumes/pg_backups/0001632ccc3918af9098_3_FULL.recm FileSize=1397435 (Compression ratio: 86.48%)
@out recm-inf: Backup Piece /Volumes/pg_backups/0001632ccc3918af9098_2_FULL.recm FileSize=1364679 (Compression ratio: 87.70%)
@out recm-inf: Backup Piece /Volumes/pg_backups/0001632ccc3918af9098_1_FULL.recm FileSize=1300808 (Compression ratio: 88.49%)
@out recm-inf: Creating piece '/Volumes/pg_backups/0001632ccc3918af9098_5_FULL.recm'
@out recm-inf: Creating piece '/Volumes/pg_backups/0001632ccc3918af9098_6_FULL.recm'
@out recm-inf: Creating piece '/Volumes/pg_backups/0001632ccc3918af9098_7_FULL.recm'
@out recm-inf: Creating piece '/Volumes/pg_backups/0001632ccc3918af9098_8_FULL.recm'
@out recm-inf: Backup Piece /Volumes/pg_backups/0001632ccc3918af9098_7_FULL.recm FileSize=2255169 (Compression ratio: 81.91%)
@out recm-inf: Creating piece '/Volumes/pg_backups/0001632ccc3918af9098_9_FULL.recm'
@out recm-inf: Backup Piece /Volumes/pg_backups/0001632ccc3918af9098_6_FULL.recm FileSize=1573429 (Compression ratio: 86.36%)
@out recm-inf: Backup Piece /Volumes/pg_backups/0001632ccc3918af9098_5_FULL.recm FileSize=1472519 (Compression ratio: 87.00%)
@out recm-inf: Backup Piece /Volumes/pg_backups/0001632ccc3918af9098_9_FULL.recm FileSize=194930 (Compression ratio: 99.77%)
@out recm-inf: Backup Piece /Volumes/pg_backups/0001632ccc3918af9098_8_FULL.recm FileSize=23797311 (Compression ratio: 96.46%)
@out NOTICE:  all required WAL segments have been archived
@out recm-inf: Ending backup at '73/7000138' (000000240000007300000007) 
@out recm-inf: Backup FULL UID '0001632ccc3918af9098' succesfully created.
@out recm-inf: Started at: '2022-09-22 22:57:29'   LSN: '73/7000028' ( 000000240000007300000007 )
@out recm-inf: Ended at..: '2022-09-22 22:58:01'   LSN: '73/7000138' ( 000000240000007300000007 )
@out recm-inf:    Cluster Name..........: 'CLU12' ( CID 1 )
@out recm-inf:    PGDATA................: '/Library/PostgreSQL/12/data'
@out recm-inf:    Total pieces .........: 9
@out recm-inf:    Total files backuped..: 3023
@out recm-inf:    Total Backup  dsize ..: 835621936 ( 796 MB )
@out recm-inf:    Elapsed Time : 32s
@inrecm
@end
*/
      ...
      while ( (ep = readdir (dp)))
      {
         ...
         case DT_LNK : lnk_name=malloc(1024);                                                                                      // Follow LINK like a folder
                       ...
                       else
                       {
                          ...
                          treeAddItem(tree,ep->d_name,TREE_ITEM_FILE,&file_st);         // dlix
                       }
...
void COMMAND_BACKUPFULL(int idcmd,char *command_line)
{
   ...
   VERBOSE("Backup cluster '%s' (CID %s)\n",varGet(GVAR_CLUNAME),varGet(GVAR_CLUCID));
   VERBOSE("Backup PGDATA folder '%s'\n",varGet(GVAR_CLUPGDATA));
   ...
   if (qualifierIsUNSET("qal_parallel") == false)                                                                                  // Validate the '/parallel=n'...must be in range 1..MAX_THREADS
   {
      ...
      if (parallel > MAX_THREADS) parallel=MAX_THREADS;                                                                            // Check the limit.
      if (parallel > 1) VERBOSE("backup use %d thread(s)\n",parallel);
   };
   ...
   // Write 'backups' information into deposit database
   int bcksts;
   ...
   // Update last backup date of cluster record
   ...
   INFO("Started at: '%s'   LSN: '%s' ( %s )\n",DEPOgetString(0,0),varGet(RECM_START_LSN),varGet(RECM_START_WALFILE));
   INFO("Ended at..: '%s'   LSN: '%s' ( %s )\n",DEPOgetString(0,1),varGet(RECM_STOP_LSN), varGet(RECM_STOP_WALFILE));
   INFO("   Cluster Name..........: '%s' ( CID %s )\n",varGet(GVAR_CLUNAME),varGet(GVAR_CLUCID));
   INFO("   PGDATA................: '%s'\n",varGet(GVAR_CLUPGDATA));
   INFO("   Total pieces .........: %s\n",DEPOgetString(0,3));
   INFO("   Total files backuped..: %lu\n", thread_all_file_processed);
   INFO("   Total Backup  dsize ..: %lu ( %s )\n",thread_all_size_processed,DisplayprettySize(thread_all_size_processed));
