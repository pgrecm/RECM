...
static struct optHelp recm_help_options[]=
{
   ...
   {CMD_SHOWBACKUP,       "uid",           "Display backup details."},
   {CMD_SHOWBACKUP,       "content",       "Display content of backup files."},
   {CMD_SHOWBACKUP,       "table",         "Display user tables (must be used with '/verbose'."},
   {CMD_SHOWBACKUP,       "index",         "Display user indexes (must be used with '/verbose'."},
   ...
   {CMD_DUPLICATEPARTIAL,  "database",     "Give the list of database to restore (default is all).\nExample:\n/database=\"demo,test\"  will restore databases 'demo' and 'test'."},
